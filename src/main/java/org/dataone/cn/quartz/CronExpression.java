package org.dataone.cn.quartz;

/**
 * I need this one class, but I don't want all of our products that depend upon
 * cn_node_registry to depend up on quartz.
 * 
 * So, until I get criticized for doing this.. I'm gonna add in this one class
 * and edit as needed for dataone specific changes.
 * 
 * @author waltz
 */
